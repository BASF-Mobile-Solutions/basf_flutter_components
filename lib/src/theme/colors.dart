...
abstract class BasfColors {
  ...
  /// Light blue color
  static const MaterialColor lightBlue = MaterialColor(0xFF21A0D2, <int, Color>{
    50: lightBluePale,
    75: lightBluePale,
  ...
  static const MaterialColor darkBlue = MaterialColor(0xFF004A96, <int, Color>{
    50: darkBluePale, //(1)
    75: darkBluePale,
  ...
  static const MaterialColor darkGreen = MaterialColor(0xFF00793A, <int, Color>{
    50: darkGreenPale,
    75: darkGreenPale,
  ...
  static const MaterialColor orange = MaterialColor(0xFFF39500, <int, Color>{
    50: orangePale, //(1)
    75: orangePale,
  ...
  /// Red MaterialColor
  static const MaterialColor red = MaterialColor(0xFFC50022, <int, Color>{
    50: redPale,
    75: redPale,
